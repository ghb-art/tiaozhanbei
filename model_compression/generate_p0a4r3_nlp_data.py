...
DEFAULT_REQUESTS = ROOT / "data" / "distill" / "p0a4r3_nlp_teacher_requests.jsonl"
DEFAULT_TRACE = ROOT / "data" / "distill" / "p0a4r3_nlp_teacher_trace.jsonl"
DEFAULT_TRAIN = ROOT / "data" / "distill" / "p0a4r3_nlp_verified_train.jsonl"
DEFAULT_VALIDATION = ROOT / "data" / "distill" / "p0a4r3_nlp_verified_validation.jsonl"
DEFAULT_AUDIT = ROOT / "reports" / "audit" / "gate_p0a4r3_nlp_data.json"
CHOICES = ("A", "B", "C", "D")
...
def select_balanced_verified(
    ...
    if len(domains) < 8:
        raise NlpDataError(
            f"{split_name} has only {len(domains)} verified domains; requires 8"
        )
