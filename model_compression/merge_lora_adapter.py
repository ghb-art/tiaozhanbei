...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Merge a shared Student LoRA into its dense base.")
    parser.add_argument("--base-model", default="models/checkpoints/p0a4/student-shared-merged")
    parser.add_argument("--adapter", required=True)
    parser.add_argument("--output", default="models/checkpoints/p0a5/student-merged")
    parser.add_argument("--audit", default="reports/audit/gate_p0a5_student_merge.json")
...
def main() -> int:
    ...
    try:
        ...
        print(f"Missing LoRA merge dependency: {exc}", file=sys.stderr)
        return 1
    ...
    report = {
        "gate": "LORA-ADAPTER-MERGE",
        "check_version": "2.0",
        "created_by": "model_compression/merge_lora_adapter.py",
