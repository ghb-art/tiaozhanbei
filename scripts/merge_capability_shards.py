...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Merge and seal deterministic official-full capability shards.")
...
def main() -> int:
    ...
    try:
        ...
        report = {
            "gate": f"CAPABILITY-{args.role.upper()}-OFFICIAL-FULL",
            "check_version": "2.0",
            "created_by": "scripts/merge_capability_shards.py",
        ...
        print(f"Capability shard merge failed: {exc}", file=sys.stderr)
        return 1
