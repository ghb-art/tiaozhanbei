...
REQUIRED_READABLE_FILES = [
    ...
    "configs/g0_capmem_candidates.json",
    "configs/p0a2_recovery.json",
    "configs/p0a3_reselection.json",
    ...
    "patches/llama_cpp_chat_utf8_sanitize.patch",
    "scripts/setup_mbpp_v23.py",
    "scripts/run_p0a.sh",
    "scripts/run_p0a2.sh",
    "scripts/run_p0a3.sh",
    "scripts/run_g0_capmem.py",
    "scripts/build_imatrix_calibration.py",
    ...
    "scripts/summarize_edge_candidate_dev.py",
    "model_compression/generate_teacher_traces.py",
    "model_compression/generate_teacher_capability_distill.py",
    "model_compression/build_capability_rehearsal.py",
    "model_compression/build_mbpp_v23.py",
    "model_compression/build_p0a2_recovery_data.py",
    "model_compression/edge_candidate_eval_utils.py",
    "model_compression/inference_utils.py",
