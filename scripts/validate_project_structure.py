...
REQUIRED_FILES = [
    ...
    "model_compression/build_p0a5_data.py",
    "model_compression/generate_p0a5_distill.py",
    "model_compression/train_p0a5_lora.py",
    "model_compression/merge_lora_adapter.py",
    "model_compression/inference_utils.py",
    "scripts/generate_formal_manifests.py",
    "scripts/evaluate_chapter2_capability.py",
    "scripts/evaluate_p0a5_gate.py",
    "scripts/p0a5_gate.py",
    "scripts/p0a5_protocol.py",
